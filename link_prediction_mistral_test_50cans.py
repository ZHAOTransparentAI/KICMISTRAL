...
def parse_args():
    ...
    parser.add_argument('--api_key', default="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", type=str)
    ...
    args.output_path = './outputs/'+ args.dataset +'/output_'+ args.query +'_mistral7b_test_50can.txt'
    args.chat_log_path = './outputs/'+ args.dataset +'/chat_'+ args.query +'_11_mistral7b_test_50can.txt'
