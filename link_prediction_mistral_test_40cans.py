...
def parse_args():
    ...
    args.output_path = './outputs/'+ args.dataset +'/output_'+ args.query +'_mistral7b_test_40can.txt'
    args.chat_log_path = './outputs/'+ args.dataset +'/chat_'+ args.query +'_11_mistral7b_test_40can.txt'
