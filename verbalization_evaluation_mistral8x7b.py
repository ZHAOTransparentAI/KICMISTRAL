...
def calculate_metrics(data):
    ...
    for entry in data:
        ...
        predictions = [pred.strip() for pred in re.split(r'[,\|]', entry['Prediction'])]
...
json_file_path = 'outputs/wn18rr/100_test/Efficient_demonstration_steps/output_tail_mistral8x7b_test_50can_eff_demon_step3.txt'
