...
def parse_args():
    ...
    parser.add_argument('--candidate_num', default=30, type=int)
    ...
    args.output_path = './outputs/'+ args.dataset +'/output_'+ args.query +'_mistral7b_test_30can.txt'
    args.chat_log_path = './outputs/'+ args.dataset +'/chat_'+ args.query +'_11_mistral7b_test_30can.txt'
