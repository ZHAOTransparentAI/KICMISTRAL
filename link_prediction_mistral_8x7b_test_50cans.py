...
def parse_args():
    ...
    parser.add_argument('--candidate_num', default=50, type=int) #default=50
    ...
    parser.add_argument('--api_key', default="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", type=str)
    ...
    args.output_path = './outputs/'+ args.dataset +'/output_'+ args.query +'_mistral8x7b_test_50can.txt'
    args.chat_log_path = './outputs/'+ args.dataset +'/chat_'+ args.query +'_mistral8x7b_test_50can.txt'
